...
STOP_WORDS = ['hasn', 'few', "it's", 'before', 'while', 'be', 'up', 'haven', 'with', 'm', "you'd", 'myself',
              ...
              'doesn', 'herself', 'or', 'y', 'so', 'she', 'all', 'both', 'hadn', 'not',
...
def clean_word(word):
    # returns cleaned word or None if input is not a propper word
    word = remove_chars(word, list("\"':;,./\\<>()-=!#$%^&*~")).lower()
